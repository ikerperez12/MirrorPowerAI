...
Write-Information (
    'La interfaz WPF real cargó valores predeterminados en una ruta temporal aislada, mostró ambos proveedores y modos de audio, expuso controles UIA y cerró configuración y overlay sin usar configuración del usuario, DPAPI, audio real, modelos ni red.'
