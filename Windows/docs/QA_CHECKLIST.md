...
- [ ] **Guardar y empezar a escuchar** persiste primero todos los valores, reinicia la sesión con esas opciones y comienza la captura; **Detener y procesar** completa el ciclo desde el panel protegido. Ambos exponen nombre y rol, y la ruta visible sigue disponible si el atajo global está ocupado o el icono de bandeja permanece oculto.
